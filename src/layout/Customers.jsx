...
function Customers() {
  return (
    <div className='bg-[#282828] relative h-[80vh]'>
        <div className=''>
            <CustomarCarousal/> 
        </div>
        ...
        <div className='flex mx-[24%] mt-5'>
            ...
            <img src={logo3} alt="logo1" className='mx-8'/>
            <img src={logo1} alt="logo1" className='mx-8' />
            <img src={logo2} alt="logo1" className='mx-8'/>
            <img src={logo3} alt="logo1" className='mx-8'/>
        </div>
    </div>
  )
